...
const team = chlTeams[Math.floor(Math.random() * chlTeams.length)];
...
function createAutocompleteList(val) {
    ...
    (_a = input.parentNode) === null || _a === void 0 ? void 0 : _a.appendChild(list);
    let count = 0;
...
function displayGuess(team, guessNumber) {
    const elementId = "guess-" + guessNumber;
    const element = document.getElementById(elementId);
    element.textContent = team;
}
function displayHint(data, guessNumber) {
    const elementId = "hint-" + guessNumber;
    const element = document.getElementById(elementId);
